    ...
    <div className="min-h-screen bg-slate-950">
      <div className="container max-w-6xl mx-auto px-4 py-8 space-y-6">
        <div>
          ...
          <p className="text-slate-400 mt-1">Join ProLnk as a real estate agent and earn referral commissions</p>
        </div>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div key="0" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-white">Agent Profile</p>
                  <p className="text-xs text-slate-400 mt-0.5">Create your professional profile with license and brokerage info</p>
                </div>
              </div>
              <div key="1" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Service Area</p>
                  <p className="text-xs text-slate-400 mt-0.5">Define your coverage area by ZIP codes or neighborhoods</p>
                </div>
              </div>
              <div key="2" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Commission Setup</p>
                  <p className="text-xs text-slate-400 mt-0.5">Configure your referral commission preferences</p>
                </div>
              </div>
              <div key="3" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Client Import</p>
                  <p className="text-xs text-slate-400 mt-0.5">Import your client list to start earning on home service referrals</p>
                </div>
              </div>
            </div>
          </CardContent>
