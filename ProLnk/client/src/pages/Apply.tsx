          ...
          <div className="lg:col-span-3">
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <p className="text-xs text-gray-500 leading-relaxed">By submitting, you agree to be contacted by the ProLnk team about your application. Your information will not be shared with third parties.</p>
