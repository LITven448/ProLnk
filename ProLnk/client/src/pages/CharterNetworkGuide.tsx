  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-20">
        <h1 className="text-4xl font-bold mb-6">Charter Network Guide</h1>
        <p className="text-xl text-gray-300 mb-10">Everything you need to know about the ProLnk Charter Network and your path to founding membership.</p>
