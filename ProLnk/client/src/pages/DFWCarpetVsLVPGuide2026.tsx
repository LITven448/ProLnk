...
const getRecommendation = (room: string, lifestyle: string): string => {
  if (room === 'Bathroom' || room === 'Kitchen') return 'LVP is the only sensible choice — waterproof, easy to clean DFW clay/dust, handles DFW temperature swings. Carpet in bathrooms is a mold risk in DFW humidity. Cost: $3-$5/sq ft installed.';
  ...
  if (lifestyle === 'Budget-Focused') return 'Budget LVP ($1.50-$2.50/sq ft) outperforms budget carpet in DFW long-term. Carpet requires cleaning every 12-18 months in DFW dust environment ($150-$300/visit). LVP is mop-and-done. 5-year TCO favors LVP even at same upfront cost.';
