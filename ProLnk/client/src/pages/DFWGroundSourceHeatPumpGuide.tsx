    ...
    <div style={{ background: '#0A1628', minHeight: '100vh', color: '#E2E8F0', fontFamily: 'system-ui, sans-serif', padding: '2rem' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ background: '#F5E642', borderRadius: 12, padding: '1.25rem', color: '#0A1628' }}>
          ...
          <div style={{ fontSize: '0.9rem', lineHeight: 1.6 }}>Geothermal heat pumps qualify for a 30% federal tax credit (IRS Form 5695) through 2032. On a $35,000 system, that is $10,500 back on your taxes. This dramatically improves payback period and makes geothermal one of the strongest home energy investments available in DFW.</div>
        </div>
      </div>
    </div>
  );
