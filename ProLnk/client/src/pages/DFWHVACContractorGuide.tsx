      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ backgroundColor: '#1a2744', borderRadius: 12, padding: 24, marginBottom: 28 }}>
          ...
          {[
            ...
            ['NATE Certification', 'North American Technician Excellence is the industry\'s leading certification. Not required by law but separates trained techs from fly-by-night operators.'],
            ...
            ['Insurance', 'General liability + workers\' comp. Ask for a certificate of insurance naming you as additional insured.'],
            ['Permit History', 'A contractor who consistently pulls permits is one who does work that passes inspection. You can call your city permit office to verify.'],
          ].map(([title, desc]) => (
        ...
        <div style={{ backgroundColor: '#1a2744', borderRadius: 12, padding: 24 }}>
          <h2 style={{ color: '#F5E642', fontSize: 20, marginBottom: 16 }}>🛠️ Project Type → Criteria & Questions</h2>
