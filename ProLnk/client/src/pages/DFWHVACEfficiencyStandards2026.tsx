...
const efficiencyData: Record<string, EfficiencyResult> = {
  'under13-any': { seer2Equiv: 'Below 12 SEER2', compliant: false, color: '#ef4444', summary: ['Systems below 13 SEER cannot be replaced with equivalent efficiency — DFW minimum is 15 SEER2 for split systems', 'This system operates at roughly 60% efficiency of current minimum code', 'Annual cooling costs are approximately $600–$1,400 more than a 15 SEER2 system in DFW'], options: ['Replacement required to meet DFW / Zone 3 minimum 15 SEER2', 'Qualify for 25C tax credit: 30% of cost up to $600 for standard AC', 'Heat pump replacement qualifies for up to $2,000 25C tax credit', 'Oncor commercial and residential rebates available for qualifying systems'] },
  '13-14-any': { seer2Equiv: '12–13 SEER2', compliant: false, color: '#ef4444', summary: ['13–14 SEER systems fall below new DFW minimum of 15 SEER2 for replacement', 'These systems cannot be replaced with like-for-like equipment in Zone 3 anymore', 'Efficiency gap costs approximately $200–$500 per year in DFW vs minimum code unit'], options: ['Any replacement must meet 15 SEER2 minimum for split systems in DFW', 'Package units have different SEER2 minimums — verify with your contractor', 'Tax credits and Oncor rebates can offset $600–$2,600 of replacement cost', 'Request SEER2-rated equipment documentation before any installation'] },
  '15-16-any': { seer2Equiv: '13.4–14.3 SEER2', compliant: true, color: '#22c55e', summary: ['15–16 SEER systems convert to approximately 13.4–14.3 SEER2 under new test conditions', 'These systems are at or just above the DFW replacement minimum for most configurations', 'Replacement with equivalent efficiency is code-compliant in Zone 3'], options: ['Can replace with minimum-compliant 15 SEER2 system', 'Upgrading to 16–18 SEER2 reduces annual DFW cooling costs by $200–$500 vs minimum', 'Heat pump option unlocks $2,000 25C tax credit and Oncor efficiency rebates', 'Variable-speed 18+ SEER2 systems provide humidity control benefit in DFW'] },
