  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-20">
        <h1 className="text-4xl font-bold mb-6">DFW Home Sale Timeline</h1>
        <p className="text-xl text-gray-300 mb-10">A step-by-step timeline for selling your home in the Dallas-Fort Worth market.</p>
