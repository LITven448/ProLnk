...
const concerns = [
  { id: 'foundation', label: '🏠 Foundation cracks or settling concerns', story: 'James in Frisco, 2025: James noticed hairline cracks in his drywall and called three foundation companies after a storm. Two were storm chasers offering $15,000 "immediate repairs." Through ProLnk, James connected with a licensed structural engineer and a verified foundation specialist. Diagnosis: normal seasonal movement, no repair needed. James saved $15,000 and got a written engineer report for his home records. Storm chasers are most active in DFW after hail events — ProLnk verifies license, insurance, and BBB standing before any pro appears on the platform.' },
  { id: 'hvac', label: '❄️ HVAC system making strange noises', story: 'Maria in Plano, 2025: Maria\’s 8-year-old Carrier unit started making a grinding noise in June. Her neighbor\’s HVAC company quoted $3,200 for a new compressor. A ProLnk-verified tech diagnosed the issue as a failing capacitor — a $25 part. The tech also found the refrigerant was 15% low and the evaporator coil was dirty. Total repair: $450. The tech documented that the compressor had 5-7 years of life remaining. Maria avoided a $5,800 unnecessary replacement. ProLnk techs are required to provide written diagnostics before any repair quote.' },
  { id: 'roof', label: '🏠 Roof damage after hail storm', story: 'David in McKinney, 2024: After a DFW hailstorm, four roofing companies showed up unsolicited at David\’s door claiming severe damage. All four recommended full replacement at $14,000-$19,000. David used ProLnk to find a verified roofing contractor with 200+ DFW reviews. The ProLnk pro found real damage — but only enough to warrant a $2,200 partial repair and insurance claim. David\’s insurance paid $1,800 of that. ProLnk pros cannot offer door-to-door services, preventing storm chaser behavior.' },
  { id: 'plumbing', label: '🚰 Slab leak or water pressure issue', story: 'Priya in Allen, 2025: Priya noticed her water bill jumped $180 in one month and heard water running with all fixtures off. She found a slab leak specialist through ProLnk. The pro used electronic leak detection to pinpoint the leak without jackhammering blindly. Repair cost: $2,100. A non-verified plumber she had called first quoted $4,800 "exploratory" work before any detection. ProLnk requires leak detection technology verification for plumbers claiming slab leak specialty.' },
  { id: 'electrical', label: '⚡ Electrical panel or wiring concern', story: 'Tom in Garland, 2024: Tom bought a 1978 DFW home and was quoted $8,500 by an electrician for a full panel replacement and rewiring. He used ProLnk to get a second opinion from a licensed master electrician. The panel was outdated but functional; the actual safety risk was two ungrounded bathroom circuits. Cost to fix: $350. The ProLnk pro documented everything for Tom\’s home records and flagged what to monitor. ProLnk electricians must carry $1M liability and be current on NEC code training.' },
];
