...
export default function DFWHomeTheaterRoomGuide2026() {
  ...
  const designs: Record<string, Record<string, string>> = {
    small: {
      low: '📺 Small Room Budget Build ($2,500-$3,500): 75" 4K QLED TV (Samsung QN75Q80C, $1,200) — DFW rooms under 16ft don\’t benefit from projectors. Denon AVR-X1800H 7.2 receiver + Klipsch Reference Theater Pack 5.0 + single 10" subwoofer. Acoustic treatment: 2 corner bass traps + 4 first-reflection foam panels. Dedicated 20A circuit for receiver is a must in DFW older homes.',
      mid: '⭐ Small Room Mid-Range ($5,000-$8,000): 85" Sony Bravia XR A95L OLED ($2,800) + Marantz Cinema 60 receiver ($1,100) + Monitor Audio Bronze 500 7.1 system ($1,200). 2" Rockwool acoustic panels at first reflection points. Add DFW electrician for dedicated 20A circuit + HDMI 2.1 conduit run. Result: reference-grade audio in compact DFW media room.',
      high: '🏆 Small Room Premium ($10,000-$15,000): Epson LS11000 4K laser projector ($4,500) on 120" ALR screen. Even in DFW bright rooms, Ambient Light Rejecting screen handles afternoon sun through plantation shutters. Anthem MRX 1140 ($3,800) + Paradigm Founder Series 7.1 ($4,200). GIK Acoustics full room treatment package. Lutron Caseta scene control.',
    },
    medium: {
      low: '📺 Medium Room Budget ($3,500-$6,000): BenQ TK700STi 4K projector on 120" screen. DFW media rooms: blackout curtains essential (DFW sun angle at 3pm destroys contrast). Yamaha RX-V6A + Klipsch RP-8060FA Dolby Atmos towers ($1,400/pair) + RP-500C center. Two 12" subs for DFW room pressurization. Bass trap in each corner.',
      mid: '⭐ Medium Room Mid-Range ($10,000-$16,000): Sony VPL-XW5000ES 4K laser projector ($6,000) never needs bulb replacement. 135" acoustic-transparent screen allows center speaker behind screen. Denon AVR-X4800H ($1,800) + Focal Chora full 7.2.4 Atmos system ($3,800). 4 cloud speakers overhead for DFW Atmos ceiling height requirements. Full GIK treatment.',
      high: '🏆 Medium Room Premium ($25,000-$35,000): JVC NZ7 4K laser projector ($15,000) with native 4K and HDR10+ processing. 150" Screen Innovations Zero Edge Pro. Anthem AVM 90 ($6,500) + Trinnov Altitude 16 processor. Genelec or JBL Synthesis full Atmos 9.2.6 system. Acoustic design by local DFW firm — first reflection, diffusion panels, cloud treatment. Riser seating with tactile transducers.',
    },
    large: {
      low: '📺 Large Room Budget ($8,000-$12,000): Large DFW theater rooms need serious horsepower. BenQ W5700 ($2,400) on 150" screen. Marantz AV10 ($6,200) + Klipsch Reference Premiere full 9.2 system ($3,800). Four 12" subs in DFW room corners for even bass distribution — critical for large-volume DFW theater rooms. Dedicated 30A sub-panel recommended.',
      mid: '⭐ Large Room Mid-Range ($20,000-$30,000): Sony VPL-GTZ380 4K laser ($18,000) — DFW large theaters justify this for zero maintenance and 10,000 lumen output. Trinnov Altitude 32 ($6,500) + JBL Synthesis SCL-2 in-wall system throughout. 160" acoustic-transparent screen. Full Atmos 13.2.6 configuration. Motorized seating risers. DFW AV integrator required for calibration.',
      high: '🏆 Large Room Ultimate ($50,000+): Full custom DFW theater. THX certification pathway. Barco Loki or Christie CP4230 commercial projector. 175" screen. Trinnov + Datasat dual processor setup. JBL Synthesis or Steinway Lyngdorf full system. Acoustic architect design — double-wall construction isolates DFW neighbor proximity. Motorized risers, in-wall tactile, bar area.',
    },
  };
