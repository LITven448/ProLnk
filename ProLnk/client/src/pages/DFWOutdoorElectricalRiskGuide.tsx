...
const featureRisks: Record<string, { risk: string; riskColor: string; required: string[]; upgrades: string[]; cost: string }> = {
  pool: {
    ...
    cost: 'GFCI upgrades: $150-$400. Full pool electrical inspection: $200-$350. Bonding upgrade: $800-$1,500.',
  },
  outdoor_kitchen: {
    ...
    cost: 'GFCI outlets: $40-$80 each installed. Weatherproof covers: $15-$30 each. Dedicated circuit: $200-$400.',
  },
  detached_garage: {
    ...
    cost: 'Sub-panel installation: $800-$2,000. GFCI upgrades: $50-$150 per outlet installed. Ground rod: $150-$300.',
  },
  landscape_lighting: {
    ...
    cost: 'Low-voltage transformer: $100-$200. Line-voltage GFCI outlet for transformer: $120-$200 installed.',
  },
  outdoor_outlets: {
    ...
    cost: 'In-use covers: $10-$20 each plus installation. GFCI outlet replacement: $80-$150 each installed.',
  },
  ev_charger: {
    ...
    cost: 'EV charger installation (circuit + charger): $1,200-$2,500. Surge protection: $200-$400. Panel upgrade if needed: $2,000-$5,000.',
  },
};
