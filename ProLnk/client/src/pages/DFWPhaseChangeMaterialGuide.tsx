...
const pcmData: Record<string, Record<string, { suitability: string; apps: string[]; savings: string; cost: string; payback: string; note: string }>> = {
  new: {
    high: { suitability: 'Excellent', apps: ['PCM drywall on west and south walls during construction', 'PCM blown-in insulation in attic -- replaces standard blown fiberglass', 'PCM in roof deck layer to absorb peak solar load', 'Radiant barrier + PCM attic combo for DFW peak load reduction'], savings: '15-25% AC savings', cost: '$2,000-$5,000 added to build', payback: '4-7 years', note: 'New construction is the best time for PCM -- installed during framing with no retrofit cost. DFW high sun means peak load reduction is significant.' },
    moderate: { suitability: 'Good', apps: ['PCM drywall on south walls and ceiling', 'PCM attic insulation layer', 'Phase change floor underlayment with tile finish'], savings: '10-18% AC savings', cost: '$2,000-$4,000 added to build', payback: '5-8 years', note: 'Moderate sun still benefits well from PCM at the new construction stage. Target attic and south walls first.' },
    low: { suitability: 'Moderate', apps: ['PCM attic insulation to handle radiant heat still present', 'PCM in interior walls for temperature smoothing', 'Focus budget on air sealing first'], savings: '8-12% AC savings', cost: '$1,500-$3,000 added to build', payback: '6-10 years', note: 'Lower sun exposure reduces PCM peak-load benefit. Still worthwhile at new construction prices but lower priority than air sealing.' },
  },
  mid: {
    high: { suitability: 'Good', apps: ['Blown-in PCM beads mixed with cellulose in attic (retrofit-friendly)', 'PCM wall panels on west-facing rooms', 'PCM ceiling tiles in hottest rooms'], savings: '10-18% AC savings', cost: '$3,500-$7,000 retrofit', payback: '6-10 years', note: 'Mid-era homes with high sun exposure see solid PCM returns. Blown-in attic PCM is most cost-effective retrofit approach.' },
    moderate: { suitability: 'Moderate', apps: ['PCM blown-in attic upgrade', 'Phase change window film (emerging product)', 'PCM insulation board on attic hatch'], savings: '8-14% AC savings', cost: '$2,800-$5,500 retrofit', payback: '7-11 years', note: 'Moderate-sun mid-era homes benefit most from attic PCM. Wall retrofits are costly -- focus on attic.' },
    low: { suitability: 'Limited', apps: ['Standard blown-in cellulose upgrade first', 'PCM only in attic if budget allows after air sealing', 'Air sealing has better ROI here'], savings: '5-10% AC savings', cost: '$2,500-$5,000 retrofit', payback: '10-14 years', note: 'Lower sun on a mid-era home means air sealing and insulation upgrade will outperform PCM investment. Do those first.' },
  },
  old: {
    high: { suitability: 'Moderate', apps: ['PCM blown-in as part of full attic gut and re-insulate', 'Fix air leaks before any PCM investment', 'PCM in new drywall if doing full renovation'], savings: '8-15% AC savings above baseline upgrade', cost: '$4,000-$9,000 as part of renovation', payback: '8-13 years', note: 'Old homes with high sun need air sealing and basic insulation first. PCM adds value on top of that base -- do not skip the basics.' },
