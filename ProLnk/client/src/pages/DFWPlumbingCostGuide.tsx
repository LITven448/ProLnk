  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-20">
        <h1 className="text-4xl font-bold mb-6">DFW Plumbing Cost Guide</h1>
        <p className="text-xl text-gray-300 mb-10">Plumbing repair and installation cost guide for Dallas-Fort Worth homeowners.</p>
