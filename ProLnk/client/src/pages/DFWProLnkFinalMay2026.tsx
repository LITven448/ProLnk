...
const roles = [
  ...
  { id: 'pro', label: 'Home service professional', status: 'Charter tier is filling fast — only 500 spots. At $149/mo locked forever, you get 60% job revenue share + 4-level network income. Waitlist closes at 500 apps.' },
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div style={{ display: 'grid', gap: 12, marginBottom: 40 }}>
          {[
            ...
            { icon: '💛', title: 'Charter Tier Benefits Locked', body: 'Charter members: $149/mo forever, 60% job revenue, 4-level network income cascade, 1.5% origination rights on homes you add to Health Vault.' },
