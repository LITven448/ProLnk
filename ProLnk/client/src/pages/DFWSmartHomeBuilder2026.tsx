...
export default function DFWSmartHomeBuilder2026() {
  ...
  const packages: Record<string, string> = {
    drhorton: '🏠 DR Horton Smart Package (Basic): Ring Video Doorbell Pro + Echo Show 5, pre-wired garage door opener, single smart thermostat. INSIST ON: upgrading to CAT6 throughout (not included by default), adding dedicated 20A circuit for home office, requesting conduit sleeves for future EV charger in garage. Builder upgrade cost: $1,200-$2,800.',
    highland: '⭐ Highland Homes Premium Smart Package: Lutron Caseta dimmer switches throughout, Ring Alarm security, Google Nest Learning Thermostat, structured media center with router shelf. INSIST ON: whole-home audio pre-wire (Highland often omits), CAT6A (not CAT6) for future 10Gb, dedicated 240V circuit for flex room. Builder upgrade cost: $4,500-$8,000.',
    shaddock: '✨ Shaddock Custom Smart Integration: Full Crestron or Control4 pre-wire, dedicated AV room with conduit, sub-panel for whole-home audio/video, Lutron RadioRA 3 throughout. INSIST ON: locking in Control4 dealer pre-construction (Shaddock has preferred vendors), specifying exact conduit paths before drywall, dedicated fiber conduit from street. Builder upgrade cost: $15,000-$35,000.',
