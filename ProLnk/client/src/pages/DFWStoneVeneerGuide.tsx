...
const DURABILITY: Record<string, Record<string, { assessment: string; maintenance: string; cost: string }>> = {
  natural: {
    accent: { assessment: 'Excellent long-term choice. DFW limestone can last 80+ years with minimal care.', maintenance: 'Seal every 5-7 years with penetrating silane. Re-point mortar every 20-25 years.', cost: 'Installation: $35-$55/sq ft. Sealing: $1.50-$3/sq ft every 5-7 years.' },
    full: { assessment: 'Highest durability option in DFW. Fire, hail, and heat resistant. Adds appraisal value.', maintenance: 'Inspect flashing annually. Repoint joints every 25-30 years.', cost: 'Installation: $50-$80/sq ft. Very low lifetime maintenance cost.' },
    water: { assessment: 'Natural limestone weathers well but watch for DFW acid rain pitting on horizontal surfaces.', maintenance: 'Apply silane sealer to horizontal cap stones annually. Vertical surfaces every 5 years.', cost: 'Sealer: $0.75-$2/sq ft. Cap stone replacement if damaged: $40-$60/stone.' },
  },
  manufactured: {
    accent: { assessment: 'Good for budget-conscious DFW projects. Watch flashing and weep screed — MSV failure is almost always water intrusion.', maintenance: 'Inspect caulk joints at windows, doors, and transitions every 3 years. Recaulk as needed.', cost: 'Installation: $15-$25/sq ft. Caulk maintenance: $300-$600 every 3-5 years.' },
    full: { assessment: 'Common in DFW new construction. Requires code-compliant weather-resistant barrier and drainage plane.', maintenance: 'Annual inspection of bottom edge (weep screed). Clean with low-pressure wash only — high pressure destroys MSV.', cost: 'Installation: $20-$35/sq ft. Repair if moisture gets behind: $3,000-$8,000.' },
    water: { assessment: 'MSV in wet DFW applications is high-risk without proper drainage. Check HOA — some prohibit below-grade MSV.', maintenance: 'Inspect every 6 months. Any soft or hollow-sounding stones indicate moisture behind veneer.', cost: 'Remediation if moisture intrusion found: $5,000-$12,000. Prevention with drainage mat: $3-$5/sq ft add.' },
  },
  thin: {
    accent: { assessment: 'Premium look at moderate cost. DFW contractors increasingly proficient with thin stone installation.', maintenance: 'Seal every 5 years. Thin format more susceptible to DFW hail chipping than full thickness.', cost: 'Installation: $25-$40/sq ft. Hail damage repair: $20-$35/sq ft partial replacement.' },
    full: { assessment: 'Strong performer in DFW. Lighter than full natural stone — structural loading less of a concern.', maintenance: 'Inspect mortar joints every 10 years. Point with matching lime mortar.', cost: 'Installation: $35-$50/sq ft. Very durable — low 20-year maintenance cost.' },
    water: { assessment: 'Good for DFW water features with proper drainage plane behind. Natural stone handles wet-dry cycles better than MSV.', maintenance: 'Seal annually at water line. Inspect for calcium buildup from DFW hard water.', cost: 'Sealing: $1-$2/sq ft annually. Calcium removal: $200-$500 as needed.' },
  },
};
