...
const neighborhoods = [
  { name: "Uptown Dallas", emoji: "🍸", tags: ["walkable","nightlife","restaurants"], best: ["social","urban"] },
  { name: "Deep Ellum", emoji: "🎸", tags: ["creative","music","arts"], best: ["creative","social"] },
  { name: "Legacy West Plano", emoji: "💼", tags: ["tech corridor","modern","amenities"], best: ["career","suburban"] },
  { name: "Lower Greenville", emoji: "🌿", tags: ["local bars","community","charming"], best: ["social","value"] },
  { name: "Knox-Henderson", emoji: "☕", tags: ["walkable","coffee","boutiques"], best: ["urban","creative"] },
];

const priorities = ["urban","social","creative","career","suburban","value"];

export default function DFWYoungProfessionalsGuide2026() {
  ...
  function recommend() {
    const scored = neighborhoods.map(n => ({
      ...n,
      score: n.best.filter(b => selected.includes(b)).length,
    }));
    ...
    <div style={{ background: "#0A1628″, minHeight: "100vh", color: "#fff", fontFamily: "sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <h1 style={{ color: "#F5E642″, fontSize: "2rem", margin: "0.5rem 0" }}>DFW Young Professionals Guide 2026</h1>
          <p style={{ color: "#94a3b8″, fontSize: "1rem" }}>Find your perfect Dallas-Fort Worth neighborhood</p>
        </div>
        ...
        <div style={{ background: "#111e35″, borderRadius: 12, padding: "1.5rem", border: "1px solid #F5E642" }}>
          <h3 style={{ color: "#F5E642″, marginTop: 0 }}>🎯 Find Your Neighborhood</h3>
          <p style={{ color: "#94a3b8″, marginBottom: "1rem" }}>Select your lifestyle priorities:</p>
          ...
          {result && (
            <div style={{ marginTop: "1rem", background: "#0A1628″, borderRadius: 8, padding: "1rem", border: "1px solid #F5E642" }}>
              <p style={{ margin: 0, color: "#F5E642″, fontWeight: 700 }}>Your match: {result.emoji} {result.name}</p>
