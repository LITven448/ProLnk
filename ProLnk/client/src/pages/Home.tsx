...
function WhyProLnkSection() {
  ...
  const advantages = [
    ...
    {
      icon: Lock,
      title: "Commission Only When You Win",
      desc: "You never pay for a lead that doesn't close. ProLnk earns only when you earn. No monthly ad spend. No pay-per-click. No wasted budget on homeowners who never respond.",
      stat: "$0",
