    ...
    <div className="container">
              ...
              <ul className="space-y-2 mb-6 flex-1">
                {tier.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-2 text-sm text-gray-600">
                    <CheckCircle className="h-4 w-4 shrink-0 mt-0.5 text-slate-900" />
                    {feature}
                  </li>
                ))}
              </ul>
      ...
      <div className="flex justify-center mb-10 -mt-8">
        <Link href="/network-stats">
          <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#1E293B]/20 bg-[#1E293B]/5 text-slate-900 text-sm font-semibold hover:bg-[#1E293B]/10 transition-colors cursor-pointer">
      ...
      <div className="max-w-4xl mx-auto mb-14">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3 mb-3">
                  <div className="p-2 rounded-lg bg-[#1E293B]/8 text-slate-900 shrink-0">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[#1E293B]/10 text-slate-900">
            Coming Soon
          </span>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2.5 mb-3">
                  <div className="p-2 rounded-lg bg-[#1E293B]/10 text-slate-900">
                    <Icon className="h-4 w-4" />
                  </div>
                  <div>
                    <div className="font-semibold text-sm text-gray-900">{addon.name}</div>
      ...
      {(addOnTotal > 0 || activeTierIdx > 0) && (
        <div className="max-w-4xl mx-auto mb-10">
          <div className="rounded-2xl border-2 border-[#1E293B] bg-[#1E293B] p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
      ...
      <div className="max-w-4xl mx-auto mb-6">
            ...
            <ul className="space-y-2.5 flex-1 mb-7">
              {["Up to 5 crew members","150 AI-analyzed jobs/mo","Commercial lead routing","Priority partner matching","Dedicated onboarding call","8% platform fee on closed jobs"].map((f) => (
                <li key={f} className="flex items-start gap-2 text-sm text-gray-700">
                  <CheckCircle className="w-4 h-4 text-slate-900 shrink-0 mt-0.5" />{f}
                </li>
              ))}
            </ul>
        ...
        <p className="text-center text-sm text-gray-400 mt-8">
          ...
          <Link href="/apply" className="text-slate-900 font-semibold hover:underline">Apply for the Exchange →</Link>
        </p>
      </div>
    </div>
  );
...
function WhyProLnkSection() {
  ...
  return (
    <section id="why-prolnk" className="py-24 relative overflow-hidden" style={{ backgroundColor: "#FAFAF8" }}>
      <div className="container">
        {/* Header */}
        <FadeUp>
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider mb-6" style={{ backgroundColor: "#1E293B12", color: "#1E293B" }}>
            ...
            <StaggerItem key={adv.title}>
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 h-full hover:shadow-md transition-shadow border-l-4" style={{ borderLeftColor: "#9A6A2F" }}>
                ...
                <div className="pt-4 border-t border-gray-100">
                  <p className="text-2xl font-heading font-bold text-slate-900">{adv.stat}</p>
        ...
        <div className="text-center mt-10">
          <Link href="/apply">
            <button className="inline-flex items-center gap-3 px-10 py-4 text-sm font-bold tracking-wide transition-all hover:opacity-90 rounded-none" style={{ backgroundColor: "#1E293B", color: "white" }}>
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        <div className="container flex items-center justify-between h-16">
              ...
              <a
                ...
                className={`transition-colors font-medium ${
                  activeSection === item.id
                    ? "text-slate-900 border-b-2 border-[#1E293B] pb-0.5"
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link href="/apply">
              <Button className="text-sm font-semibold text-white rounded-none px-5" style={{ backgroundColor: "#1E293B" }}>
                Apply Now
              </Button>
            </Link>
          </div>
          ...
          <div className="md:hidden border-t border-gray-100 bg-white px-4 py-4 space-y-3">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Link href="/apply" className="flex-1">
                <Button className="w-full text-sm text-white rounded-none font-semibold" style={{ backgroundColor: "#1E293B" }}>Apply Now</Button>
              </Link>
            </div>
            {!isTrustyPro && (
      ...
      <section className="py-16 bg-white border-b border-gray-100">
        <div className="container">
          <FadeUp>
            <div className="text-center mb-10">
              <p className="text-xs font-bold uppercase tracking-widest text-slate-900/40 mb-3">Personalize Your Experience</p>
                ...
                <button
                  ...
                  className={`w-full flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all duration-200 hover:-translate-y-0.5 ${
                    selectedTrade === trade.label
                      ? 'border-[#1E293B] bg-[#1E293B] text-white shadow-lg'
                      : 'border-gray-200 bg-white text-gray-700 hover:border-[#1E293B]/40 hover:shadow-md'
                  }`}
                >
          ...
          {selectedTrade && (
            <FadeUp>
              <div className="max-w-lg mx-auto text-center p-5 rounded-2xl border border-[#1E293B]/10 bg-[#1E293B]/5">
                <p className="text-sm text-gray-600">
                  <strong className="text-slate-900">{selectedTrade} pros</strong> on the Pro tier uploading ~50 photos/month could earn an estimated{" "}
                  ...
                  <a href="#pricing" className="ml-2 text-slate-900 font-bold underline underline-offset-2">See your estimate →</a>
                </p>
              </div>
            </FadeUp>
          )}
      ...
      <section className="py-24 bg-white">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeUp>
              <p className="text-xs text-slate-900/70 font-semibold uppercase tracking-widest mb-4">AI Detection in Action</p>
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-gray-900 mb-6 leading-tight">
                One Photo.<br />
                <span className="text-slate-900">Multiple Commission Opportunities.</span>
              </h2>
              ...
              <div className="space-y-3 mb-8">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#1E293B]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-slate-900 text-xs font-bold">{i + 1}</span>
                    </div>
                    <div>
      ...
      {/* — 3. Who Can Join — */}
      <section id="who-can-join" className="py-20" style={{ backgroundColor: "#FAFAF8" }}>
        <div className="container">
          <FadeUp>
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-slate-900 bg-[#1E293B]/8 px-4 py-2 rounded-full mb-4">
          ...
          <div className="mt-10 text-center">
            ...
            <Link href="/apply">
              <button className="px-8 py-3 text-sm font-bold border-2 border-[#1E293B] text-slate-900 hover:bg-[#1E293B] hover:text-white transition-all rounded-none">
      ...
      <section id="fsm-compat" className="py-20 bg-white border-t border-gray-100">
        <div className="container">
          ...
          <FadeUp>
            <div className="max-w-5xl mx-auto bg-[#1E293B] rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6">
              <div className="flex-1">
      ...
      <section id="badge-system" className="py-24" style={{ backgroundColor: "#FAFAF8" }}>
        <div className="container">
          <FadeUp>
                    ...
                    <ul className="space-y-1.5">
                      {badge.unlocks.map((unlock) => (
                        <li key={unlock} className="flex items-start gap-2 text-xs text-gray-600">
                          <Zap className="w-3.5 h-3.5 mt-0.5 shrink-0 text-slate-900" />
                          {unlock}
                        </li>
                      ))}
                    </ul>
      ...
      <section id="guarantee" className="py-24" style={{ backgroundColor: "#FAFAF8" }}>
        <div className="container">
