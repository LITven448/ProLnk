    ...
    <div className="min-h-screen bg-slate-950">
      <div className="container max-w-6xl mx-auto px-4 py-8 space-y-6">
        <div>
          ...
          <p className="text-slate-400 mt-1">Frequently asked questions about the ProLnk partner program</p>
        </div>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div key="0" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-white">Getting Started</p>
                  <p className="text-xs text-slate-400 mt-0.5">How to sign up, get verified, and start receiving leads</p>
                </div>
              </div>
              <div key="1" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Commissions</p>
                  <p className="text-xs text-slate-400 mt-0.5">How commissions work, when you get paid, and tax info</p>
                </div>
              </div>
              <div key="2" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Leads & Referrals</p>
                  <p className="text-xs text-slate-400 mt-0.5">How leads are distributed and how to improve your match rate</p>
                </div>
              </div>
              <div key="3" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">Managing your profile, service area, and notification preferences</p>
                </div>
              </div>
            </div>
          </CardContent>
