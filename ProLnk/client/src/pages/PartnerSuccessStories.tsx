    ...
    <div className="min-h-screen bg-slate-950">
      <div className="container max-w-6xl mx-auto px-4 py-8 space-y-6">
        <div>
          ...
          <p className="text-slate-400 mt-1">Real stories from ProLnk partners who have grown their business</p>
        </div>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div key="0" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-white">Top Earners</p>
                  <p className="text-xs text-slate-400 mt-0.5">Profiles of partners earning $10K+ per month through ProLnk</p>
                </div>
              </div>
              <div key="1" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Growth Journeys</p>
                  <p className="text-xs text-slate-400 mt-0.5">How partners went from startup to established businesses</p>
                </div>
              </div>
              <div key="2" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Referral Champions</p>
                  <p className="text-xs text-slate-400 mt-0.5">Partners who built networks of 50+ referral sources</p>
                </div>
              </div>
              <div key="3" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Innovation Stories</p>
                  <p className="text-xs text-slate-400 mt-0.5">Partners using AI photo analysis to win more jobs</p>
                </div>
              </div>
            </div>
          </CardContent>
