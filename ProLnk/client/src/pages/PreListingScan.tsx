...
export default function PreListingScan() {
  return (
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8 space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Pre-Listing Home Scan
          </h1>
          <p className="text-slate-400 mt-1">Order an AI home scan before listing to identify and address issues early</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card className="bg-slate-800/60 border-slate-700">
            ...
            <CardContent>
              <Badge className="bg-teal-500/20 text-teal-400">Agent Portal</Badge>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div key="0" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-white">Order Scan</p>
                  <p className="text-xs text-slate-400 mt-0.5">Request a comprehensive home scan for any property</p>
                </div>
              </div>
              <div key="1" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">Get detailed findings with severity and cost estimates</p>
                </div>
              </div>
              <div key="2" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Repair Coordination</p>
                  <p className="text-xs text-slate-400 mt-0.5">Connect sellers with verified pros to fix issues before listing</p>
                </div>
              </div>
              <div key="3" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Report Sharing</p>
                  <p className="text-xs text-slate-400 mt-0.5">Share clean reports with potential buyers</p>
                </div>
              </div>
            </div>
          </CardContent>
