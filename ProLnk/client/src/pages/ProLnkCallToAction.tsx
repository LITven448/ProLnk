...
const pitches: Record<Prospect, Record<SitType, { reason: string; gain: string[]; loss: string[]; next: string }>> = {
  'licensed contractor': {
    'just exploring': {
      ...
      next: 'Browse the lead feed at prolnk.xyz — no commitment required to see what\’s available',
    },
    'ready to join': {
      ...
      next: 'Apply at prolnk.xyz/pro — 3 fields, 4 minutes, done',
    },
    'on the fence': {
      reason: 'The fence is expensive — Charter won\’t exist in 6 months',
      gain: ['📋 Apply with zero commitment — explore the platform before you decide', '💬 Talk to a current Charter contractor: partner@prolnk.xyz', '🔄 Cancel anytime in the first 30 days — no questions asked'],
  ...
  'sales professional': {
    'just exploring': {
      ...
      next: 'Download the income structure at prolnk.xyz/partners and model your market',
    },
    'ready to join': {
      ...
      next: 'Apply at prolnk.xyz/partner — 5 minutes to Charter status',
    },
    'on the fence': {
      ...
      next: 'Email partner@prolnk.xyz with "Fence" in the subject — we\’ll answer every question',
    },
  },
  'homeowner': {
    'just exploring': {
      ...
      next: 'Post your first job free at prolnk.xyz — see who\’s available in your zip code',
    },
    'ready to join': {
      ...
      next: 'Post your job at prolnk.xyz — it takes less time than calling 3 contractors',
    },
    'on the fence': {
      ...
      next: 'Try it risk-free at prolnk.xyz — post one job, see what comes back',
    },
  },
  'investor': {
    'just exploring': {
      ...
      next: 'Request the data room: invest@prolnk.xyz — deck and financials returned same day',
    },
    'ready to join': {
      ...
      next: 'Email invest@prolnk.xyz with "Committed" in subject — we move fast',
    },
    'on the fence': {
      ...
      next: 'Schedule a founder call: invest@prolnk.xyz — 30 minutes, all questions welcome',
    },
  },
};
