...
const API_CREDITS = [
  ...
  },
  {
    ...
    apis: [
      {
        name: "OpenAI (Built-in via Manus)",
        freeCredits: "Included in Manus platform — no additional cost",
        monthlyFreeUnits: "Unlimited via platform key",
        costAfterFree: "Covered by Manus subscription",
        url: "https://manus.im",
      ...
      {
        name: "Anthropic Claude (via Manus)",
        freeCredits: "Included in Manus platform",
        monthlyFreeUnits: "Available via platform",
        costAfterFree: "Covered by Manus subscription",
        url: "https://manus.im",
        useCase: "Alternative deep analysis model — better for structured JSON output",
        priority: "secondary",
        notes: "Access via Manus built-in API. Useful as fallback when GPT-4o is rate-limited.",
        setupSteps: [
    ...
    apis: [
      {
        ...
        priority: "primary",
        notes: "$200/month credit covers most small-to-medium usage. Already configured via Manus proxy.",
        setupSteps: [
          "Already active via Manus Maps proxy",
