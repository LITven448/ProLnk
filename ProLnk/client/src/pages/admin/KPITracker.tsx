    ...
    <AdminLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-400 mt-1">Track key performance indicators with goals and progress indicators</p>
        </div>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div key="0" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-white">Goal Setting</p>
                  <p className="text-xs text-slate-400 mt-0.5">Set monthly and quarterly goals for each KPI</p>
                </div>
              </div>
              <div key="1" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Progress Tracking</p>
                  <p className="text-xs text-slate-400 mt-0.5">Visual progress bars and trend indicators</p>
                </div>
              </div>
              <div key="2" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">Get notified when KPIs fall below targets</p>
                </div>
              </div>
              <div key="3" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Comparison</p>
                  <p className="text-xs text-slate-400 mt-0.5">Compare current vs previous period performance</p>
                </div>
              </div>
            </div>
          </CardContent>
