          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Textarea
                ...
                className="bg-[#0A1628] border-slate-700 text-white placeholder-slate-500 min-h-[80px]"
              />
            </div>
            ...
            <Button onClick={handlePublish} className="w-full bg-teal-500 hover:bg-teal-400 text-white py-3 text-base font-semibold">
              Publish Spotlight
            </Button>
          </div>
        </div>
