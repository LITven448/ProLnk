    ...
    <div className="min-h-screen bg-slate-950">
      <div className="container max-w-6xl mx-auto px-4 py-8 space-y-6">
        <div>
          ...
          <p className="text-slate-400 mt-1">Step-by-step guide to filing insurance claims with documentation support</p>
        </div>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div key="0" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-white">Claim Wizard</p>
                  <p className="text-xs text-slate-400 mt-0.5">Guided flow to collect all information needed for a claim</p>
                </div>
              </div>
              <div key="1" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Photo Documentation</p>
                  <p className="text-xs text-slate-400 mt-0.5">AI-organized photos formatted for insurance submission</p>
                </div>
              </div>
              <div key="2" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Damage Assessment</p>
                  <p className="text-xs text-slate-400 mt-0.5">AI-generated damage report with severity and cost estimates</p>
                </div>
              </div>
              <div key="3" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Carrier Submission</p>
                  <p className="text-xs text-slate-400 mt-0.5">Pre-formatted claim package ready to submit</p>
                </div>
              </div>
            </div>
          </CardContent>
