    ...
    <div className="min-h-screen bg-slate-950">
      <div className="container max-w-6xl mx-auto px-4 py-8 space-y-6">
        <div>
          ...
          <p className="text-slate-400 mt-1">High-level overview of all your properties and their condition</p>
        </div>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div key="0" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-white">Health Score Summary</p>
                  <p className="text-xs text-slate-400 mt-0.5">Average health score across all properties</p>
                </div>
              </div>
              <div key="1" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Maintenance Calendar</p>
                  <p className="text-xs text-slate-400 mt-0.5">Upcoming maintenance tasks across all properties</p>
                </div>
              </div>
              <div key="2" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">Total maintenance spend by property and category</p>
                </div>
              </div>
              <div key="3" className="flex items-start gap-3 p-3 bg-slate-800/40 rounded-lg">
                <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0" />
                <div>
                  <p className="text-sm text-white">Comparison View</p>
                  <p className="text-xs text-slate-400 mt-0.5">Compare condition and costs between properties</p>
                </div>
              </div>
            </div>
          </CardContent>
