...
const BRAND = "#2563EB";
const BRAND_LIGHT = "rgba(37,99,235,0.15)";
const BRAND_BORDER = "rgba(37,99,235,0.4)";
const NAVY = "#0a0f1e";
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  boxShadow: focusedField === "email" ? `0 0 0 3px rgba(37,99,235,0.15)` : "none",
                }}
              />
            </div>
