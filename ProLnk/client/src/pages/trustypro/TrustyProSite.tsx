  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta name="description" content="Get matched with verified, background-checked home service professionals using AI. The smart way to find plumbers, HVAC, electricians and more." />
