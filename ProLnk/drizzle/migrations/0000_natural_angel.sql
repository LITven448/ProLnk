...
CREATE TABLE `achAuthorizations` (
	...
	`authorizationType` text NOT NULL DEFAULT ('single_job'),
...
CREATE TABLE `agentHomeownerReferrals` (
	...
	`saleStatus` text NOT NULL DEFAULT ('active'),
...
CREATE TABLE `aiPipelineRuns` (
	...
	`jobId` int,
	`partnerId` int,
	`stage` text NOT NULL DEFAULT ('preprocessing'),
...
CREATE TABLE `aiTrainingDataset` (
	...
	`validationOutcome` text DEFAULT ('pending'),
	`propertyType` varchar(50),
	`propertyZip` varchar(20),
	`propertyState` varchar(50),
	`capturedMonth` int,
...
CREATE TABLE `commissions` (
	...
	`disputeAppealStatus` text NOT NULL DEFAULT ('none'),
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()),
...
CREATE TABLE `exchangeJobs` (
	...
	`title` varchar(255) NOT NULL,
	`description` text NOT NULL,
	`jobType` text NOT NULL DEFAULT ('residential'),
	`tradeCategory` varchar(100) NOT NULL,
...
CREATE TABLE `homeWaitlist` (
	...
	`ownershipStatus` text DEFAULT ('own'),
	`ownershipType` text DEFAULT ('primary_residence'),
	...
	`projectTimeline` text DEFAULT ('just_exploring'),
...
CREATE TABLE `homeowner360Profiles` (
	...
	`budgetComfort` text DEFAULT ('value_seeker'),
	...
	`decisionMaker` text DEFAULT ('solo'),
	`decisionSpeed` text DEFAULT ('within_week'),
	`hiringCriteria` json DEFAULT ('[]'),
	`requiresBackground` boolean NOT NULL DEFAULT false,
	`communicationStyle` text DEFAULT ('text_first'),
	`bestTimeToContact` text DEFAULT ('anytime'),
	`responseExpectation` text DEFAULT ('same_day'),
	`prefersVideoConsult` boolean NOT NULL DEFAULT false,
	`planningToSell` boolean NOT NULL DEFAULT false,
	`sellTimeframe` text DEFAULT ('not_planning'),
	`primaryHomeGoal` text,
	`topProjectCategories` json DEFAULT ('[]'),
	`dreamProjects` text,
	`referralMotivation` text DEFAULT ('credits'),
...
CREATE TABLE `jobPayments` (
	...
	`paymentMethod` text NOT NULL DEFAULT ('card_on_file'),
...
CREATE TABLE `messages` (
	...
	`sender_type` text NOT NULL DEFAULT ('homeowner'),
...
CREATE TABLE `partner360Profiles` (
	...
	`techComfortLevel` text DEFAULT ('medium'),
	`primaryGoal` text,
	...
	`communicationStyle` text DEFAULT ('text_first'),
	`bestTimeToContact` text DEFAULT ('anytime'),
	`preferredLeadType` text DEFAULT ('residential'),
	`avgJobSize` text,
...
CREATE TABLE `partners` (
	...
	`stripeConnectStatus` text NOT NULL DEFAULT ('not_connected'),
	`bankAccountLast4` varchar(4),
	`payoutReadyAt` timestamp,
	`trialStatus` text NOT NULL DEFAULT ('trial'),
...
CREATE TABLE `photoQueueItems` (
	...
	`ingestionMode` text NOT NULL DEFAULT ('live'),
	`photoAgeMonths` int,
	`partnerId` int,
	`jobId` int,
	`batchId` int,
...
CREATE TABLE `properties` (
	...
	`garageType` text DEFAULT ('none'),
	`hasFence` boolean NOT NULL DEFAULT false,
	`fenceType` text DEFAULT ('none'),
	...
	`drivewaySurface` text DEFAULT ('none'),
	`garageSpaces` int DEFAULT 0,
	`storiesCount` text,
	`flooringTypes` json DEFAULT ('[]'),
	`kitchenCountertop` text DEFAULT ('unknown'),
	`primaryBathType` text DEFAULT ('unknown'),
	`fireplaceType` text DEFAULT ('none'),
	`fireplaceCount` int DEFAULT 0,
	`ceilingHeight` text DEFAULT ('standard_8ft'),
	`windowType` text DEFAULT ('unknown'),
	`applianceBrands` json DEFAULT ('{}'),
	`lawnSize` text,
	`hasGardenBeds` boolean NOT NULL DEFAULT false,
	`treeCount` text DEFAULT ('none'),
	`hasPets` boolean NOT NULL DEFAULT false,
	`dogCount` int DEFAULT 0,
	`dogBreedSize` text DEFAULT ('none'),
	...
	`aiMockupStatus` text DEFAULT ('pending'),
...
CREATE TABLE `seasonalPrepItems` (
	...
	`diyDifficulty` text NOT NULL DEFAULT ('moderate'),
	`sortOrder` int NOT NULL DEFAULT 0,
	`isActive` boolean NOT NULL DEFAULT true,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
