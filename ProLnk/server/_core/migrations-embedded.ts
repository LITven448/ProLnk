...
export const MIGRATION_0000 = "CREATE TABLE IF NOT EXISTS \\`acceptanceSignals\\` (
	\\`id\\` int NOT NULL,
...
export const MIGRATION_0001 = "ALTER TABLE \\`achAuthorizations\\` MODIFY COLUMN \\`accountType\\` varchar(255) DEFAULT 'checking';--> statement-breakpoint
